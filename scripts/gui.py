...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.carga_value.place(x=math.floor(width*0.25*0.25),y=math.floor(data_frame_height*0.6*0.2))
        ...
        self.sinc_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.6*0.2))
        ...
        self.descargas_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.6*0.2))
