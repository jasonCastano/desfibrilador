...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.time_label = Label(self,bg="#353231",fg="#EEE110",font=data_small_label_font)
        self.time_label.place(x=math.floor(width*0.55), y=math.floor(height*0.01))
        self.time_now()
        self.date_label = Label(self,bg="#353231",fg="#EEE110", font=data_small_label_font)
        ...
        self.modo_value.place(x=math.floor(width*0.25),y=math.floor(data_frame_height*0.3))
        ...
        self.carga_value.place(x=math.floor(width*0.38 + (width*0.25*0.25)),y=math.floor(data_frame_height*0.2 + (data_frame_height*0.6*0.5)))
        ...
        self.sinc_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.25*0.03))
        ...
        self.descargas_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.25*0.03))
