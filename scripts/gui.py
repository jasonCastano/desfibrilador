...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.carga_value.place(x=math.floor(width*0.15*0.22),y=math.floor(data_frame_height*0.35*0.01))
        ...
        self.sinc_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.35*0.01))
        ...
        self.descargas_value.place(x=math.floor(width*0.12*0.22),y=math.floor(data_frame_height*0.35*0.01))
