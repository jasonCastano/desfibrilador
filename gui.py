...
class Window(Frame):
    ...
    def init_window(self):
        ...
        self.lpm_value_label.place(x=math.floor(width*0.05),y=math.floor(data_frame_height*0.2))
        ...
        carga_frame = Frame(data_frame, bg = "#827F7D", width=math.floor(width*0.15), height=math.floor(data_frame_height*0.25))
        ...
        #sinc_label.place(x=math.floor(width*0.43),y=math.floor(data_frame_height*0.01))
    def time_now(self):
        now = datetime.now()
