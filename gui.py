...
class Window(Frame):
    ...
    def init_window(self):
        ...
        sinc_label.place(x=math.floor(width*0.73),y=math.floor(data_frame_height*0.01))
        ...
        self.sinc_value_label = Label(sinc_frame, bg="#827F7D",fg="#34EB13", text="R", font=data_big_label_font)
