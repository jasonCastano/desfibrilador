...
class Window(Frame):
    ...
    def init_window(self):
        ...
        carga_label.place(x=math.floor(width*0.4),y=math.floor(data_frame_height*0.01))
        self.carga_value_label = Label(data_frame, bg="#A8A5A4",fg="#34EB13", text="260J", font=data_big_label_font)
        self.carga_value_label.place(x=math.floor(width*0.38),y=math.floor(data_frame_height*0.2))
    def time_now(self):
        now = datetime.now()
